...
<!-- Login Start -->
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <img src="<?php echo "../asset/images/Mobil3.png" ?>" alt="login" width="730px" height="840px">
            </div>
            <div class="col-md-4">
                ...
                <form action="{{ route('login.action') }}" method="POST" >
                    ...
                    <h5 class="forRegister fw-light mt-2">Udah Punya akun belum?? <a href="/register">Daftar</a></h5>
                </form>
            </div>
        </div>
    </div>
